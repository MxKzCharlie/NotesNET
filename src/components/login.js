function Login(){
    return(
        ...
        <div className="flex flex-col items-center nm-flat-white-xs w-96 h-96 rounded-lg">
            ...
            <button className="text-lg nm-flat-emerald-700-xs text-emerald-300 mt-5 px-4 rounded-md 
            transition ease-in-out delay-300ms hover:scale-110 active:scale-100">
                Sign In
            </button>
            <a href="https://www.instagram.com/carcruz18/"
            className="no-underline text-emerald-800 mt-10 hover:text-emerald-600">
